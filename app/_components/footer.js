...
export default function Footer() {
    return (
        <footer className="backdrop-blur-sm px-2 mr-4">
            <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
                {/* Links */}
                <div className="flex flex-col md:justify-between md:flex-row items-center md:items-start">
                    {/* Branding */}
                    <div className="mb-6 md:mb-0">
                        <Branding />
                    </div>
                    {/* Information */}
                    <div className="grid grid-cols-1 gap-9 sm:gap-16 sm:grid-cols-2">
                        {/* Resources */}
                        <div>
                ...
                <div className="flex items-center sm:justify-between flex-col sm:flex-row">
                    <span className="text-sm text-gray-950 text-center">© 2023 <a href="/" className="hover:font-medium">Simmer Eats™</a>. All Rights Reserved.
                    </span>

                    {/* Social Links */}
                    <div className="flex mt-4 space-x-6 justify-center sm:mt-0 px-1">
                        {/* Facebook */}
                        <a href="#" className="text-gray-900 hover:text-green-700" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* GitHub */}
                        <a href="https://github.com/raquel-f" className="text-gray-900 hover:text-green-700" target="_blank" rel="noopener noreferrer">
